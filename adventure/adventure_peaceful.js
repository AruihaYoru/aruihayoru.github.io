...
function findWasmBinary() {
    return locateFile("adventure_peaceful.wasm")
}
...
var ASM_CONSTS = {
    ...
    4886: () => {
        window.crystal_key = 1
    }
};
var _set_key, _get_screen_buffer, _main, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
    _set_key = Module["_set_key"] = wasmExports["e"];
    _get_screen_buffer = Module["_get_screen_buffer"] = wasmExports["f"];
    ...
    __indirect_function_table = wasmTable = wasmExports["h"]
}
var wasmImports = {
    a: _emscripten_asm_const_int,
    b: _emscripten_set_main_loop
};
